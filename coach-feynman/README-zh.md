...
费曼学习法（或者叫费曼技巧）就是通过教学输出深化对知识的理解、提升学习效率，再借助教学过程中的反馈，校验自身的知识掌握程度、补全认知漏洞，形成完整的学习闭环（有很多网友考究过费曼学习法，并不是由费曼本人创造的，是由那个花一年学完麻省理工4年课程的学习网红 [Scott Young](https://www.scotthyoung.com/blog/2024/03/26/5-keys-feynman-technique/) ，根据费曼文章中学习方法为灵感创造的。但是基于这个方法的名称广为流传，我们在此仍沿用这个名称）。

虽说费曼学习法提高学习效率的逻辑成立，且广受好评，但落地实践时却存在一个致命bug：太难找到合适的“听讲对象”了！要么对方的知识水平和咱们的学习进度不匹配，要不就是听不懂你讲啥，没法接话提问，要不就是他已经懂你要说啥了，还能抢话了；要么碍于他人的时间与意愿，很难长期配合我们完成反复讲解、提问的流程，这也是很多人尝试后半途而废的核心原因。

但我们现在有 AI 了呀。这个最大的难题有解了。我们完全可以给 AI 捏个专属人设，把它定制成最贴合需求的专属倾听者 + 提问者。它永远不会对你的反复讲解感到不耐烦，会不遗余力地针对知识点提出针对性问题，更有能力判断你的回答是否真正切中要点、是否存在逻辑漏洞，还能顺着你的回答持续深挖新问题。如果你觉得讲的不好想重来，可以把他的记忆（上下文）一键刷新。而且对于i人来说，AI全程无痛配合、无压力互动。妈妈，我再也不用为找学习搭子头疼啦！

为了更好更流程地利用 AI 能力，我把费曼学习法的逻辑和实操步骤整理了对应的Skill（本文是面向普通人的实操指南，这个[开源项目](https://github.com/YMoose/my-claude-sidekick/tree/main/coach-feynman)是需要安装到 AI agent 上，搭配本文使用的），帮助尝试AI时代的全新费曼学习法，把高效学习落到实处。

## 工作流

以下就是写给作为人类的你的费曼学习法Skill文档。把[coach-feynman](https://github.com/YMoose/my-claude-sidekick/tree/main/coach-feynman)装载到你的 agent(Claude/Codex/Openclaw) 上的同时，把这个skill装载到你的实践中。
...
不必把每一轮都当成考试现场。卡壳了、讲劈叉了、被问住了，都很正常。这些时刻往往不是你“不行”，反而说明你已经“要长脑子”了。更重要的是持续推进、持续修正。
